...
| [Releasing](releasing.md) | How versions are cut: VERSION file, changelog discipline, the tag-triggered gate, and tarballs. |

For the security posture and how to report vulnerabilities, see
[SECURITY.md](../SECURITY.md). To contribute, see
